...
const MATERIAL = {
  NAME: 'MATERIAL.NAME',
  WARNING_STOCK_NAME: 'MATERIAL.WARNING_STOCK_NAME',
  LIST: {
  ...
  FILTER: {
    ...
    WARNING_STOCK_NAME: 'MATERIAL.FILTER.WARNING_STOCK_NAME',
    LABELS: {
...
const SCHEDULE = {
  NAME: 'SCHEDULE.NAME',
  LATE_NAME: 'SCHEDULE.LATE_NAME',
  LIST: {
    ID: 'SCHEDULE.LIST.ID',
    CLIENT_NAME: 'SCHEDULE.LIST.CLIENT_NAME',
    SCHEDULE_STATUS_NAME: 'SCHEDULE.LIST.SCHEDULE_STATUS_NAME',
    DATE: 'SCHEDULE.LIST.DATE',
    FINISH_DATE: 'SCHEDULE.LIST.FINISH_DATE',
    CANCEL_DATE: 'SCHEDULE.LIST.CANCEL_DATE',
    IN_LOCO: 'SCHEDULE.LIST.IN_LOCO',
  },
  FILTER: {
    NAME: 'SCHEDULE.FILTER.NAME',
    LATE_NAME: 'SCHEDULE.FILTER.LATE_NAME',
    LABELS: {
      ID: 'SCHEDULE.FILTER.LABELS.ID',
      NAME: 'SCHEDULE.FILTER.LABELS.NAME',
      BEGIN_DATE: 'SCHEDULE.FILTER.LABELS.BEGIN_DATE',
      END_DATE: 'SCHEDULE.FILTER.LABELS.END_DATE',
      IN_LOCO: 'SCHEDULE.FILTER.LABELS.IN_LOCO',
      IN_LOCO_OPTIONS: {
        ALL: 'SCHEDULE.FILTER.LABELS.IN_LOCO_OPTIONS.ALL',
        YES: 'SCHEDULE.FILTER.LABELS.IN_LOCO_OPTIONS.YES',
        NOT: 'SCHEDULE.FILTER.LABELS.IN_LOCO_OPTIONS.NOT',
      },
      SCHEDULE_STATUS: "SCHEDULE.FILTER.LABELS.SCHEDULE_STATUS",
      SCHEDULE_STATUS_MULTIPLE_SELECTED: "SCHEDULE.FILTER.LABELS.SCHEDULE_STATUS_MULTIPLE_SELECTED",
      SCHEDULE_STATUS_ALL_SELECTED: "SCHEDULE.FILTER.LABELS.SCHEDULE_STATUS_ALL_SELECTED",
    }
  },
  STATUS: {
...
const PRODUCT = {
  NAME: 'PRODUCT.NAME',
  ON_SALE_NAME: 'PRODUCT.ON_SALE_NAME',
  LIST: {
    ...
    MESSAGES: {
      CONFIRM_DELETE: {
        TITLE: "PRODUCT.LIST.MESSAGES.CONFIRM_DELETE.TITLE",
        MESSAGE: "PRODUCT.LIST.MESSAGES.CONFIRM_DELETE.MESSAGE",
      },
      CONFIRM_RESTORE: {
        TITLE: "PRODUCT.LIST.MESSAGES.CONFIRM_RESTORE.TITLE",
        MESSAGE: "PRODUCT.LIST.MESSAGES.CONFIRM_RESTORE.MESSAGE",
      },
    }
  },
  ADD: {
  ...
  FILTER: {
    ...
    ON_SALE_NAME: "PRODUCT.FILTER.ON_SALE_NAME",
    LABELS: {
  ...
  EDIT: {
    ...
    LABELS: {
      ANTECIPATE: 'PRODUCT.EDIT.LABELS.NAME',
      EXTEND: 'PRODUCT.EDIT.LABELS.EXTEND',
      START: 'PRODUCT.EDIT.LABELS.START',
      END: 'PRODUCT.EDIT.LABELS.END',
    }
  },
  CARD_INFO: {
  ...
  CARD_SCHEDULES: {
    NAME: "PRODUCT.CARD_SCHEDULES.NAME",
    LABELS: {
      INITIAL_DATE: "PRODUCT.CARD_SCHEDULES.LABELS.INITIAL_DATE",
      FINAL_DATE: "PRODUCT.CARD_SCHEDULES.LABELS.FINAL_DATE",
      SCHEDULE_STATUS: "PRODUCT.CARD_SCHEDULES.LABELS.SCHEDULE_STATUS",
      SCHEDULE_STATUS_MULTIPLE_SELECTED: "PRODUCT.CARD_SCHEDULES.LABELS.SCHEDULE_STATUS_MULTIPLE_SELECTED",
      SCHEDULE_STATUS_ALL_SELECTED: "PRODUCT.CARD_SCHEDULES.LABELS.SCHEDULE_STATUS_ALL_SELECTED",
    },
    LIST: {
      ID: 'PRODUCT.CARD_SCHEDULES.LIST.ID',
      CLIENT_NAME: 'PRODUCT.CARD_SCHEDULES.LIST.CLIENT_NAME',
      SCHEDULE_STATUS_NAME: 'PRODUCT.CARD_SCHEDULES.LIST.SCHEDULE_STATUS_NAME',
      DATE: 'PRODUCT.CARD_SCHEDULES.LIST.DATE',
      CANCEL_DATE: 'PRODUCT.CARD_SCHEDULES.LIST.FINISH_DATE',
      FINISH_DATE: 'PRODUCT.CARD_SCHEDULES.LIST.CANCEL_DATE',
      IN_LOCO: 'PRODUCT.CARD_SCHEDULES.LIST.IN_LOCO',
    }
  },
  CHANGE_SALE: {
    END_NAME: 'PRODUCT.CHANGE_SALE.END_NAME',
    START_NAME: 'PRODUCT.CHANGE_SALE.START_NAME',
    ANTECIPATE_NAME: 'PRODUCT.CHANGE_SALE.ANTECIPATE_NAME',
    EXTEND_NAME: 'PRODUCT.CHANGE_SALE.EXTEND_NAME',
    LABELS: {
      PRICE: 'PRODUCT.CHANGE_SALE.LABELS.PRICE',
      PROMOTIONAL_PRICE: 'PRODUCT.CHANGE_SALE.LABELS.PROMOTIONAL_PRICE',
      END_SALE: 'PRODUCT.CHANGE_SALE.LABELS.END_SALE',
    },
    MESSAGES: {
      CONFIRM_END: 'PRODUCT.CHANGE_SALE.MESSAGES.CONFIRM_END',
    }
  },
  CARD_SALES: {
    NAME: "PRODUCT.CARD_SALES.NAME",
    LABELS: {
      INITIAL_DATE: "PRODUCT.CARD_SALES.LABELS.INITIAL_DATE",
      FINAL_DATE: "PRODUCT.CARD_SALES.LABELS.FINAL_DATE",
      SALE_STATUS: "PRODUCT.CARD_SALES.LABELS.SALE_STATUS",
      SALE_STATUS_MULTIPLE_SELECTED: "PRODUCT.CARD_SALES.LABELS.SALE_STATUS_MULTIPLE_SELECTED",
      SALE_STATUS_ALL_SELECTED: "PRODUCT.CARD_SALES.LABELS.SALE_STATUS_ALL_SELECTED",
    },
    LIST: {
      SALE_STATUS_NAME: 'PRODUCT.CARD_SALES.LIST.SALE_STATUS_NAME',
      DATE: 'PRODUCT.CARD_SALES.LIST.DATE',
      CREATED_AT: 'PRODUCT.CARD_SALES.LIST.CREATED_AT',
      PRICE: 'PRODUCT.CARD_SALES.LIST.PRICE',
    }
  },
}
...
const COMBO = {
  NAME: 'COMBO.NAME',
  ON_SALE_NAME: 'COMBO.ON_SALE_NAME',
  LIST: {
    ...
    MESSAGES: {
      CONFIRM_DELETE: {
        TITLE: "COMBO.LIST.MESSAGES.CONFIRM_DELETE.TITLE",
        MESSAGE: "COMBO.LIST.MESSAGES.CONFIRM_DELETE.MESSAGE",
      },
      CONFIRM_RESTORE: {
        TITLE: "COMBO.LIST.MESSAGES.CONFIRM_RESTORE.TITLE",
        MESSAGE: "COMBO.LIST.MESSAGES.CONFIRM_RESTORE.MESSAGE",
      },
    }
  },
  ADD: {
  ...
  FILTER: {
    ...
    ON_SALE_NAME: "COMBO.FILTER.ON_SALE_NAME",
    LABELS: {
  ...
  EDIT: {
    ...
    LABELS: {
      ANTECIPATE: 'COMBO.EDIT.LABELS.NAME',
      EXTEND: 'COMBO.EDIT.LABELS.EXTEND',
      START: 'COMBO.EDIT.LABELS.START',
      END: 'COMBO.EDIT.LABELS.END',
    }
  },
  CARD_INFO: {
  ...
  DETAILS: {
    NAME: 'COMBO.DETAILS.NAME',
  },
  CARD_GRAPHS: {
    LABELS: {
      YEAR: "COMBO.CARD_GRAPHS.LABELS.YEAR",
      SCHEDULE_FINISHED_IN_YEAR: "COMBO.CARD_GRAPHS.LABELS.SCHEDULE_FINISHED_IN_YEAR",
      SCHEDULE_FINISHED_TOTAL: "COMBO.CARD_GRAPHS.LABELS.SCHEDULE_FINISHED_TOTAL",
      SCHEDULE_FINISHED: "COMBO.CARD_GRAPHS.LABELS.SCHEDULE_FINISHED",
      SCHEDULE_CANCELED_IN_YEAR: "COMBO.CARD_GRAPHS.LABELS.SCHEDULE_CANCELED_IN_YEAR",
      SCHEDULE_CANCELED_TOTAL: "COMBO.CARD_GRAPHS.LABELS.SCHEDULE_CANCELED_TOTAL",
      SCHEDULE_CANCELED: "COMBO.CARD_GRAPHS.LABELS.SCHEDULE_CANCELED",
      SCHEDULE_FINISHED_AND_CANCELED_IN_YEAR: "COMBO.CARD_GRAPHS.LABELS.SCHEDULE_FINISHED_AND_CANCELED_IN_YEAR",
    }
  },
  CARD_SCHEDULES: {
    NAME: "COMBO.CARD_SCHEDULES.NAME",
    LABELS: {
      INITIAL_DATE: "COMBO.CARD_SCHEDULES.LABELS.INITIAL_DATE",
      FINAL_DATE: "COMBO.CARD_SCHEDULES.LABELS.FINAL_DATE",
      SCHEDULE_STATUS: "COMBO.CARD_SCHEDULES.LABELS.SCHEDULE_STATUS",
      SCHEDULE_STATUS_MULTIPLE_SELECTED: "COMBO.CARD_SCHEDULES.LABELS.SCHEDULE_STATUS_MULTIPLE_SELECTED",
      SCHEDULE_STATUS_ALL_SELECTED: "COMBO.CARD_SCHEDULES.LABELS.SCHEDULE_STATUS_ALL_SELECTED",
    },
    LIST: {
      ID: 'COMBO.CARD_SCHEDULES.LIST.ID',
      CLIENT_NAME: 'COMBO.CARD_SCHEDULES.LIST.CLIENT_NAME',
      SCHEDULE_STATUS_NAME: 'COMBO.CARD_SCHEDULES.LIST.SCHEDULE_STATUS_NAME',
      DATE: 'COMBO.CARD_SCHEDULES.LIST.DATE',
      CANCEL_DATE: 'COMBO.CARD_SCHEDULES.LIST.FINISH_DATE',
      FINISH_DATE: 'COMBO.CARD_SCHEDULES.LIST.CANCEL_DATE',
      IN_LOCO: 'COMBO.CARD_SCHEDULES.LIST.IN_LOCO',
    }
  },
  CHANGE_SALE: {
    END_NAME: 'COMBO.CHANGE_SALE.END_NAME',
    START_NAME: 'COMBO.CHANGE_SALE.START_NAME',
    ANTECIPATE_NAME: 'COMBO.CHANGE_SALE.ANTECIPATE_NAME',
    EXTEND_NAME: 'COMBO.CHANGE_SALE.EXTEND_NAME',
    LABELS: {
      PRICE: 'COMBO.CHANGE_SALE.LABELS.PRICE',
      PROMOTIONAL_PRICE: 'COMBO.CHANGE_SALE.LABELS.PROMOTIONAL_PRICE',
      END_SALE: 'COMBO.CHANGE_SALE.LABELS.END_SALE',
    },
    MESSAGES: {
      CONFIRM_END: 'COMBO.CHANGE_SALE.MESSAGES.CONFIRM_END',
    }
  },
  CARD_SALES: {
    NAME: "COMBO.CARD_SALES.NAME",
    LABELS: {
      INITIAL_DATE: "COMBO.CARD_SALES.LABELS.INITIAL_DATE",
      FINAL_DATE: "COMBO.CARD_SALES.LABELS.FINAL_DATE",
      SALE_STATUS: "COMBO.CARD_SALES.LABELS.SALE_STATUS",
      SALE_STATUS_MULTIPLE_SELECTED: "COMBO.CARD_SALES.LABELS.SALE_STATUS_MULTIPLE_SELECTED",
      SALE_STATUS_ALL_SELECTED: "COMBO.CARD_SALES.LABELS.SALE_STATUS_ALL_SELECTED",
    },
    LIST: {
      SALE_STATUS_NAME: 'COMBO.CARD_SALES.LIST.SALE_STATUS_NAME',
      DATE: 'COMBO.CARD_SALES.LIST.DATE',
      CREATED_AT: 'COMBO.CARD_SALES.LIST.CREATED_AT',
      PRICE: 'COMBO.CARD_SALES.LIST.PRICE',
    }
  },
}
...
const CLIENT = {
  ...
  EDIT: {
    NAME: 'CLIENT.EDIT.NAME',
    LABELS: {
      NAME: 'CLIENT.EDIT.LABELS.NAME',
      NICKNAME: 'CLIENT.EDIT.LABELS.NICKNAME',
      SEX_OPTIONS: {
        MALE: 'CLIENT.EDIT.LABELS.SEX_OPTIONS.MALE',
        FEMALE: 'CLIENT.EDIT.LABELS.SEX_OPTIONS.FEMALE'
      },
      EMAIL: 'CLIENT.EDIT.LABELS.EMAIL',
      BIRTHDAY: 'CLIENT.EDIT.LABELS.BIRTHDAY',
      PHONE: 'CLIENT.EDIT.LABELS.PHONE',
      CELL_PHONE: 'CLIENT.EDIT.LABELS.CELL_PHONE',
      OCCUPATION: 'CLIENT.EDIT.LABELS.OCCUPATION',
      ADDRESS: {
        STREET: 'CLIENT.EDIT.LABELS.ADDRESS.STREET',
        NUMBER: 'CLIENT.EDIT.LABELS.ADDRESS.NUMBER',
        DISTRICT: 'CLIENT.EDIT.LABELS.ADDRESS.DISTRICT',
        COUNTRY: 'CLIENT.EDIT.LABELS.ADDRESS.COUNTRY',
        CITY: 'CLIENT.EDIT.LABELS.ADDRESS.CITY',
        COMPLEMENT: 'CLIENT.EDIT.LABELS.ADDRESS.COMPLEMENT',
      },
    }
  },
  FILTER: {},
  ...
  CARD_GRAPHS: {
    LABELS: {
      YEAR: "CLIENT.CARD_GRAPHS.LABELS.YEAR",
      SCHEDULE_FINISHED_IN_YEAR: "CLIENT.CARD_GRAPHS.LABELS.SCHEDULE_FINISHED_IN_YEAR",
      SCHEDULE_FINISHED_TOTAL: "CLIENT.CARD_GRAPHS.LABELS.SCHEDULE_FINISHED_TOTAL",
      SCHEDULE_FINISHED: "CLIENT.CARD_GRAPHS.LABELS.SCHEDULE_FINISHED",
      SCHEDULE_CANCELED_IN_YEAR: "CLIENT.CARD_GRAPHS.LABELS.SCHEDULE_CANCELED_IN_YEAR",
      SCHEDULE_CANCELED_TOTAL: "CLIENT.CARD_GRAPHS.LABELS.SCHEDULE_CANCELED_TOTAL",
      SCHEDULE_CANCELED: "CLIENT.CARD_GRAPHS.LABELS.SCHEDULE_CANCELED",
      SCHEDULE_FINISHED_AND_CANCELED_IN_YEAR: "CLIENT.CARD_GRAPHS.LABELS.SCHEDULE_FINISHED_AND_CANCELED_IN_YEAR",
    }
  },
  CARD_SCHEDULES: {
    NAME: "CLIENT.CARD_SCHEDULES.NAME",
    LABELS: {
      INITIAL_DATE: "CLIENT.CARD_SCHEDULES.LABELS.INITIAL_DATE",
      FINAL_DATE: "CLIENT.CARD_SCHEDULES.LABELS.FINAL_DATE",
      SCHEDULE_STATUS: "CLIENT.CARD_SCHEDULES.LABELS.SCHEDULE_STATUS",
      SCHEDULE_STATUS_MULTIPLE_SELECTED: "CLIENT.CARD_SCHEDULES.LABELS.SCHEDULE_STATUS_MULTIPLE_SELECTED",
      SCHEDULE_STATUS_ALL_SELECTED: "CLIENT.CARD_SCHEDULES.LABELS.SCHEDULE_STATUS_ALL_SELECTED",
    },
    LIST: {
      ID: 'CLIENT.CARD_SCHEDULES.LIST.ID',
      CLIENT_NAME: 'CLIENT.CARD_SCHEDULES.LIST.CLIENT_NAME',
      SCHEDULE_STATUS_NAME: 'CLIENT.CARD_SCHEDULES.LIST.SCHEDULE_STATUS_NAME',
      DATE: 'CLIENT.CARD_SCHEDULES.LIST.DATE',
      CANCEL_DATE: 'CLIENT.CARD_SCHEDULES.LIST.FINISH_DATE',
      FINISH_DATE: 'CLIENT.CARD_SCHEDULES.LIST.CANCEL_DATE',
      IN_LOCO: 'CLIENT.CARD_SCHEDULES.LIST.IN_LOCO',
    }
  },
}
