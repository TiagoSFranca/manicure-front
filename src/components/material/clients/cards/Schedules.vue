<template>
  <div>
    ...
    >
      <v-card-title>
        <span class="overline">
          {{ $t(i18nConstants.CLIENT.CARD_SCHEDULES.NAME) }}
        </span>
      </v-card-title>
      <v-card-text>
        <v-row align="end">
          <v-col cols="12" md="6" lg="3">
            <common-date-picker
              ...
              :label="
                $t(i18nConstants.CLIENT.CARD_SCHEDULES.LABELS.INITIAL_DATE)
              "
          ...
          <v-col cols="12" md="6" lg="3">
            <common-date-picker
              :date="filter.endDate"
              :label="$t(i18nConstants.CLIENT.CARD_SCHEDULES.LABELS.FINAL_DATE)"
          ...
          <v-col cols="12" md="6" lg="4">
            <v-select
              ...
              item-text="name"
              :label="
                $t(i18nConstants.CLIENT.CARD_SCHEDULES.LABELS.SCHEDULE_STATUS)
              "
            >
              <template v-slot:selection="{ item, index }">
                ...
                >
                  {{
                    $t(
                      i18nConstants.CLIENT.CARD_SCHEDULES.LABELS
...
export default {
  data() {
    return {
      headers: [
        ...
        {
          text: this.$t(i18nConstants.CLIENT.CARD_SCHEDULES.LIST.ID),
          align: "start",
          value: "id",
        },
        {
          text: this.$t(i18nConstants.CLIENT.CARD_SCHEDULES.LIST.CLIENT_NAME),
          value: "client.name",
          align: "center",
        },
        {
          text: this.$t(
            i18nConstants.CLIENT.CARD_SCHEDULES.LIST.SCHEDULE_STATUS_NAME
          ),
          value: "scheduleStatus.name",
          align: "center",
        },
        {
          text: this.$t(i18nConstants.CLIENT.CARD_SCHEDULES.LIST.DATE),
          value: "date",
          align: "center",
        },
        {
          text: this.$t(i18nConstants.CLIENT.CARD_SCHEDULES.LIST.FINISH_DATE),
          value: "finishDate",
          align: "center",
        },
        {
          text: this.$t(i18nConstants.CLIENT.CARD_SCHEDULES.LIST.CANCEL_DATE),
          value: "cancelDate",
          align: "center",
        },
        {
          text: this.$t(i18nConstants.CLIENT.CARD_SCHEDULES.LIST.IN_LOCO),
          value: "inLoco",
          align: "center",
        },
      ...
      pagination: {},
      sort: {},
      LOADING_IDENTIFIER: "searchClientSchedules",
    };
  },
  methods: {
    searchSchedules() {
      ...
      clientsActions.searchSchedules(
        id,
        this.filter,
        this.pagination,
        this.sort,
  ...
  computed: {
    ...mapState(clientsConstants.MODULE_NAME, ["schedules", "schedulesPage"]),
